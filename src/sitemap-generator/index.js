...
module.exports = function SitemapGenerator(uri, opts) {
  ...
  // crawler.on('invaliddomain', (queueItem, response) =>
  //  console.log('invalid: ', queueItem)
  // );
  ...
  crawler.on('fetchcomplete', (queueItem, page) => {
    ...
    if (
      ...
      if (sitemapPath !== null) {
        ...
        sitemap.addURL(url, depth, lastMod && format(lastMod, 'YYYY-MM-DD'), options.customPriorityFreq);
      }
    }
  });
